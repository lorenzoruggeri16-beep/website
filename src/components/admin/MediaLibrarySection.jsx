    ...
    <div className="max-w-[1600px] mx-auto">
      <header className="mb-12 flex flex-wrap items-end justify-between gap-6">
        <div>
          ...
          <h2 className="text-6xl font-light">Media Library</h2>
        </div>
